...
donate_text = "You can support this project by your participation. For example, by offering your help for translating the interface in a language you master or by enriching the FAQ.{{{<br>}}}{{{<br>}}}If you appreciate the work done, you can make a contribution, even a few cents. You will need a Paypal or a Tib account and the money will be used to pay for website hosting, mobile applications submission, code maintenance and new functionalities on the project.{{{<br>}}}{{{<br>}}}Thank you for your support. It is greatly appreciated and encourages me to continue."